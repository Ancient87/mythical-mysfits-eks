...
This is currently a 1-part workshop adoption of [The original](https://github.com/aws-samples/aws-modern-application-workshop) for EKS instead of ECS

### Session Times

For now we only converted the [first workshop](workshop-1-k8s).